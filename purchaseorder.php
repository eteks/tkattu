...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
          ...
          <td><table width="95%" align="center" cellpadding="0" cellspacing="0" class="tableborder">
              ...
              <tr>
                <td width="100%" height="30" align="center" valign="middle" class="verdanablack"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <th height="30" bgcolor="#D7DBB0" class="style1" scope="col">Purchase Order Information</th>
                    </tr>
                  </table></td>
              </tr>
              <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
                    ...
                    <tr class="tableborder">
                      ...
                      <td align="right" valign="middle" class="verdanablack"><label>&nbsp; </label></td>
                      <td align="right" valign="middle" class="verdanablack"><label>Vendor Name : </label></td>
                      <td align="left" valign="middle" class="verdanablack"><select onchange="getVendorItem(this.value)"   style="width:125px;" name="main_menu_id" id="main_menu_id" >
                          <option  value="">Select</option>
                          <?php
	 $item_fetch_singrec_sql =  "SELECT *  FROM " . TABLE_HMS_ITEM_ENTRY. " where active ='Y' ";
	...
	?>
                          <option value="<?php echo $hms_info_values1['vendor_name']; ?>"> <?php echo $hms_info_values1['vendor_name']; ?> </option>
                          <?php
      } }
      ?>
                        </select></td>
                      <td width="24%" align="center" valign="middle" class="verdanablack">&nbsp;</td>
                    </tr>
                    <tr class="tableborder">
                      <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="right" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="right" valign="middle" class="verdanablack">Item Type :</td>
                      <td align="left" valign="middle" class="verdanablack"><div id="vendor_item_type">
                          <select  style="width:125px;" name="item_type_id" id="item_type_id" >
                            <option  value="">Select</option>
                          </select>
                        </div></td>
                    ...
                    <tr class="tableborder">
                      ...
                      <td align="right" valign="middle" class="verdanablack">Form:</td>
                      <td align="left" valign="middle" class="verdanablack"><input name="ddDateFrom" id="ddDateFrom" class="inputCopy1" type="text" tabindex="19" size='16' value=""/>
                        <img src="images/Calendar New.jpg" width="16" height="16" style="cursor:pointer" onclick="return showCalendar('ddDateFrom','%m/%d/%Y',24, true);" /></td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                    </tr>
                    <tr class="tableborder">
                      <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="right" valign="middle" class="verdanablack">To:</td>
                      <td align="left" valign="middle" class="verdanablack"><input name="ddDateTo" id="ddDateTo" type="text" tabindex="20" class="inputCopy1" size='16' value=""/>
                        <img src="images/Calendar New.jpg" width="16" height="16" style="cursor:pointer" onclick="return showCalendar('ddDateTo','%m/%d/%Y',24, true);" /></td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                    </tr>
                    <tr class="tableborder">
                      <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="center" valign="middle" class="verdanablack">Show</td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                      <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
                    </tr>
                    <tr class="tableborder">
