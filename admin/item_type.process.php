...
?>
<form name="frmnewsletter_manageRecords" method="get" action="<? echo href_link(FILENAME_ITEM_TYPE);?>" style="margin:0px;">
      ...
      <tr>
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" height="20" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_ITEM_TYPE;?></td>
			</tr>
		  </table></td>
      </tr>
   <tr>
    ...
    <tr>
         ...
         <th width="17%" style="text-align:center" >Item Type Name </th>
		 <th width="25%" style="text-align:center" >Creaded Date </th>
		 <th width="28%" style="text-align:center" >Modified Date </th>
		 <th width="9%" style="text-align:center" >Ingredient </th>
    ...
    <tr>
        ...
        <td width = "25%" style="text-align:center" class="tahoma11blacknormal" bgcolor="<?php echo $bgcolor; ?>"><?php echo date_long( $hms_info_values["date_modified"] ); ?></td>

		<td width="9%" align="center" class="tahoma11blacknormal" bgcolor="<? echo $bgcolor ?>" ><? echo (($hms_info_values["ingredient"] == "Y") ? "Yes" : "No"); ?></td>

		<td width="5%" align="center" bgcolor="<? echo $bgcolor ?>" ><a href="javascript:populateHotelInfoManageLists ('<? echo $hms_info_values["item_type_id"] ?>', 'item_update_active', '<? echo (($hms_info_values["active"] == "Y") ? "N" : "Y"); ?>', '<? print $page ;?>', '');"><img src="images/<? echo $hms_info_values["active"]; ?>.gif" border="0" <? if ($hms_info_values["active"]=='Y'){print "title='Click to disable'";} else { print "title='Click to enable'";}?>></a></td>

        <td width="4%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo FILENAME_ITEM_TYPE_VIEW. '?id=' . $hms_info_values["item_type_id"]; ?>" onClick="return hs.htmlExpand(this, { objectType: 'ajax'} )"><img src="images/view.gif" width="16" height="16" border="0" /></a></td>

        <td width="4%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo href_link(FILENAME_ITEM_TYPE, 'id=' . $hms_info_values["item_type_id"] . '&action=item_edit&page=' . $page) ?>"><img src="images/edit.gif" alt="Edit" border="0" title="Click to edit"></a></td>

        <td width="5%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="javascript:deleteHmsInfoManageRecord(document.frmnewsletter_manageRecords, 'item_manage_delete', '<? echo $hms_info_values["item_type_id"] ?>')"><img src="images/delete.gif" alt="Delete" border="0" title="Click to delete"></a></td>
  </tr>
    <?php
          $hms_info_counter++;
        }
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
  <tr>
   <td colspan="10" class="gray_headline"><table border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td style="padding-left:6px"><img src="images/arrow_heading.gif" /></td>
       <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_ITEM_TYPE;?></td>
     </tr>
   </table></td>
  </tr>
  <tr>
