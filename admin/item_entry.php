...
checklogin();
$module_title = TITLE_MANAGE_ITEM_ENTRY;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"], 82) ) {
...
switch ($_REQUEST['action']) {
    case "item_insert":
        ...
        redirect (href_link(FILENAME_ENTRY_TYPE, 'page=' . $page));
    break;
    case "item_update":
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INVENTORY . FILENAME_ENTRY_TYPE);?>
         </td>
       </tr>
     </table>
   </td>
