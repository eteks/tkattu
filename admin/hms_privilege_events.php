...
switch($_POST["action"]){
    case "privilege_module_event_insert":   
        ...
        redirect(href_link(FILENAME_HMS_PRIVILEGE_EVENTS, 'module_event_parent_id='.$_POST["module_event_parent_id"]));
    break;
    ...
    case "privilege_module_event_delete":
        ...
        redirect(href_link(FILENAME_HMS_PRIVILEGE_EVENTS, 'module_event_parent_id='.$_POST["parent_moduleid"]));
    break;
}
?>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
                        <?php require_once(DIR_WS_PRIVILEGE_USER .FILENAME_HMS_PRIVILEGE_EVENTS);?> </td>
         </td>
       </tr>
     </table>
   </td>
