...
checklogin();
$module_title = TITLE_MANAGE_DESIGNATION;
...
switch ($_REQUEST['action']) {
    case "designation_insert":
        $hms_info_obj->designationInsert();
        redirect (href_link(FILENAME_DESIGNATION, 'page=' . $page));
    break;
    case "designation_update":
        $hms_info_obj->designationUpdate();
        redirect (href_link(FILENAME_DESIGNATION, 'page=' . $page));
    break;
    case "designation_manage_delete":
        $hms_info_obj->designationDelete($id);
        redirect (href_link(FILENAME_DESIGNATION, 'page=' . $page));
    break;
    case "delete_selected_hmsInfo_manage_records":
        $hms_info_obj->deletedesignationMultipleRecord();
        redirect (href_link(FILENAME_DESIGNATION, 'page=' . $page));
    break;
}
?>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/designation.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INFRASTUCTURE . FILENAME_DESIGNATION);?>
         </td>
       </tr>
     </table>
   </td>
