...
checklogin();
$module_title = TITLE_MANAGE_SUPPLIER_CREATION;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"],97) ) {
...
switch ($action) {
    case "suppliercreation_insert":
        $hms_info_obj->tableTypeInsert();
        redirect (href_link(FILENAME_SUPPLIER, 'page=' . $page));
    break;
    case "suppliercreation_update":
        $hms_info_obj->tableTypeUpdate();
        redirect (href_link(FILENAME_SUPPLIER, 'page=' . $page));
    break;
    case "suppliercreation_manage_delete":
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/suppliercreation.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INFRASTUCTURE . FILENAME_SUPPLIER);?>
         </td>
       </tr>
     </table>
   </td>
