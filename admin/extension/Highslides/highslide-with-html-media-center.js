...
getSelfRendered : function() {
	var s =	
		...
		+	'<li class="highslide-previous"><a onmouseover="return hs.previous(this)" href="#">'+ hs.previousText +'</a></li>'
		+	'<li class="highslide-next"><a onmouseover="return hs.next(this)" href="#">'+ hs.nextText +'</a></li>'
		+	'<li class="highslide-move"><a href="#" onmouseover="return false">'+ hs.moveText +'</a></li>'
		+	'<li class="highslide-close"><a onmouseover="return hs.close(this)" title="'+ hs.closeTitle +'" href="#">'
			+ hs.closeText +'</a></li>'
		+'</ul></div>'
...
isHsAnchor : function (a) {
	return (a.onmouseover && a.onmouseover.toString().replace(/\s/g, ' ').match(/hs.(htmlE|e)xpand/));
},
...
hs.Expander = function(a, params, custom, contentType) {
	...
	this.wrapper.ononmouseover = function (e) { 
...
displayLoading : function() {
	...
	var exp = this;
	this.loading.onmouseover = function() {
		exp.cancelLoading();
	};
...
preloadNext : function() {
	...
	if (next.onmouseover.toString().match(/hs\.expand/)) 
...
wrapperMouseHandler : function (e) {
	if (!e) e = window.event;
	var over = /onmouseover/i.test(e.type); 
	if (!e.target) e.target = e.srcElement; // ie
