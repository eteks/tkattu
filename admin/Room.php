...
checklogin();
$module_title = TITLE_MANAGE_ROOM;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"], 76) ) {
...
switch ($_REQUEST['action']) {
    case "room_insert":
        $hms_info_obj->RoomInsert();
        redirect (href_link(FILENAME_ROOM, 'page=' . $page));
    break;
    case "room_update":
        $hms_info_obj->RoomUpdate();
        redirect (href_link(FILENAME_ROOM, 'page=' . $page));
    break;
    case "room_delete":
        $hms_info_obj->roomDelete($id);
        redirect (href_link(FILENAME_ROOM, 'page=' . $page));
    break;
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/Room.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INFRASTUCTURE . FILENAME_ROOM);?>
         </td>
       </tr>
     </table>
   </td>
