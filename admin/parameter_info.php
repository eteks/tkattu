...
checklogin();
$module_title = "Parameter Setting";
...
switch ($_REQUEST['action']) {
    case "hms_parameter_insert":
        $hms_parameter_obj->hmsParameterInsert();
        redirect (href_link(FILENAME_PARAMETER_INFO, 'page=' . $page));
    break;
    case "hms_parameter_update":
        $hms_parameter_obj->hmsParameterUpdate();
        redirect (href_link(FILENAME_PARAMETER_INFO, 'page=' . $page));
    break;
    case "hms_parameter_manage_delete":

        $hms_parameter_obj->hmsParameterDelete($id);
        redirect (href_link(FILENAME_PARAMETER_INFO, 'page=' . $page));
    break;
    case "delete_selected_hmsparameter_manage_records":
        $hms_parameter_obj->deleteHmsParameterManageMultipleRecord();
        redirect (href_link(FILENAME_PARAMETER_INFO, 'page=' . $page));
    break;
}
?>
...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/hotel_info.js"></script>
	 <script language="javascript" type="text/javascript" src="js/parameter_info.js"></script>
             ...
             <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
                     <?php require_once(DIR_WS_BASIC_INFO . FILENAME_PARAMETER_INFO);?>
                 </td>
               </tr>
             </table>
           </td>
