...
switch ($action) {
    case "facility_entry_update_active":
        $hms_info_obj->facilityEntryUpdateActive();
    break;
    case "facility_entry_insert":
        echo $hms_info_obj->checkDuplicate('insert');
        exit;
    break;
    case "facility_entry_update":
...
?>
<form name="frmnewsletter_manageRecords" method="get" action="<? echo href_link(FILENAME_FACILITY_ENTRY);?>" style="margin:0px;">
      ...
      <tr>
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_FACILITY_ENTRY;?></td>
			</tr>
		  </table></td>
      </tr>
   <tr>
       <td height="30" colspan="2"><input style="cursor:pointer;" class="buttons" type="button" name="Delete_Selected" value="Delete Selected" disabled onclick="deleteSelectedHmsInfoManageRecord(document.frmnewsletter_manageRecords, 'facility_selected_hmsInfo_manage_records');"></td>
    ...
    <tr>
         ...
         <th width="23%" style="text-align:center" >Facility Name</th>
		...
		<th width="6%" style="text-align:center" >Active</th>
         <th width="6%" style="text-align:center" >View</th>
    ...
    ?> 
    <tr>
        <td width="5%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><input type="checkbox" class="noneborder" onclick="change_box_stat(document.frmnewsletter_manageRecords, 'All');set_button_stat(document.frmnewsletter_manageRecords, 'All', document.frmnewsletter_manageRecords.Delete_Selected);" name="newsletter_manage_ids[]" value="<? print $hms_info_values["hms_facility_entry_id"]; ?>"></td>

        <td style="text-align:center" width="23%" class="tahoma11blacknormal" bgcolor="<? echo $bgcolor ?>" >
        <? if(strlen($hms_info_values["hms_facility_entry_name"]) > 30) echo substr(stripslashes($hms_info_values["hms_facility_entry_name"]),0,28).".."; else echo stripslashes($hms_info_values["hms_facility_entry_name"]); ?></td>
		
        <td width = "27%" style="text-align:center" class="tahoma11blacknormal" bgcolor="<?php echo $bgcolor; ?>"><?php echo date_long( $hms_info_values["date_added"] ); ?></td>
		...
		<td width="6%" align="center" bgcolor="<? echo $bgcolor ?>" ><a href="javascript:populateHotelInfoManageLists ('<? echo $hms_info_values["hms_facility_entry_id"] ?>', 'facility_entry_update_active', '<? echo (($hms_info_values["active"] == "Y") ? "N" : "Y"); ?>', '<? print $page ;?>', '');"><img src="images/<? echo $hms_info_values["active"]; ?>.gif" border="0" <? if ($hms_info_values["active"]=='Y'){print "title='Click to disable'";} else { print "title='Click to enable'";}?>></a></td>

        <td width="6%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo FILENAME_FACILITY_ENTRY_VIEW . '?id=' . $hms_info_values["hms_facility_entry_id"]; ?>" onClick="return hs.htmlExpand(this, { objectType: 'ajax'} )"><img src="images/view.gif" width="16" height="16" border="0" /></a></td>

        <td width="6%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo href_link(FILENAME_FACILITY_ENTRY, 'id=' . $hms_info_values["hms_facility_entry_id"] . '&action=facility_entry_edit&page=' . $page) ?>"><img src="images/edit.gif" alt="Edit" border="0" title="Click to edit"></a></td>

        <td width="6%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="javascript:deleteHmsInfoManageRecord(document.frmnewsletter_manageRecords, 'facility_entry_delete', '<? echo $hms_info_values["hms_facility_entry_id"] ?>')"><img src="images/delete.gif" alt="Delete" border="0" title="Click to delete"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
  <tr>
   <td colspan="10" height="30" class="gray_headline"><table border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td style="padding-left:6px" align="left"><img src="images/arrow_heading.gif" /></td>
       <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_FACILITY_ENTRY;?></td>
     </tr>
   </table></td>
  </tr>
