...
if (db_num_rows($modules_event_master)) {
    ?>
    <form name="frmPrivilegeEventModules" method="POST" action="<?php echo href_link(FILENAME_PRIVILEGE_EVENTS,'event_module_parent_id='.$_GET["event_module_parent_id"]);?>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" class="ntab">
      ...
      <tr>
          ...
          <td width="3%" align="center" class="tahoma11blacknormal" bgcolor="<? echo $bgcolor ?>"><a title="To edit current record" href="<?php echo href_link(FILENAME_PRIVILEGE_EVENTS, 'id=' . $modules_event_master_values["id"] .'&event_module_parent_id='.$event_module_parent_id.'&action=privilege_module_event_edit'); ?>"><img src="images/edit.gif" width="15" height="15" alt="Edit" border="0"></a></td>
...
<?php
    ...
    print "<center><span class=\"normaltext\"><b>NO EVENTS FOUND</b></span></center>";
}
?>
