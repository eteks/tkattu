...
checklogin();
$module_title = TITLE_MANAGE_TABLE_TYPE_CREATION;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"],77) ) {
...
switch ($action) {
    case "table_type_insert":
        $hms_info_obj->tableTypeInsert();
        redirect (href_link(FILENAME_TABLE_TYPE, 'page=' . $page));
    break;
    case "table_type_update":
        $hms_info_obj->tableTypeUpdate();
        redirect (href_link(FILENAME_TABLE_TYPE, 'page=' . $page));
    break;
    case "table_type_manage_delete":
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/table_type.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INFRASTUCTURE . FILENAME_TABLE_TYPE);?>
         </td>
       </tr>
     </table>
   </td>
