...
session_start();
checklogin();
$module_title = TITLE_MANAGE_HMS_SERVICE;
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/Menu_Card.js"></script>
     <script language="javascript" type="text/javascript" src="js/report_service.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_REPORT . FILENAME_REPORT_SERVICE);?>
         </td>
       </tr>
     </table>
   </td>
