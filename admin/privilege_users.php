...
switch ($action) {
    case "privilege_user_insert":
        ...
        redirect (href_link(FILENAME_PRIVILEGE_USERS,'parent_id='.$_GET["parent_id"]));
    break;
    case "privilege_user_update":
        $privilegeUser_obj->privilegeUserUpdate();
        redirect (href_link(FILENAME_PRIVILEGE_USERS,'parent_id='.$_GET["parent_id"].'&page=' . $_GET["page"]));
    break;
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
                        <?php require_once(DIR_WS_PRIVILEGE . 'privilege_users.php');?> </td>
         </td>
       </tr>
     </table>
   </td>
