...
checklogin();
$module_title = TITLE_MANAGE_OCCASION_INFO;
...
switch ($_REQUEST['action']) {
    case "occasion_insert":
        $hms_info_obj->occasionInsert();
        redirect (href_link(FILENAME_OCCASION_INFO, 'page=' . $page));
    break;
    case "occasion_update":
        $hms_info_obj->occasionUpdate();
        redirect (href_link(FILENAME_OCCASION_INFO, 'page=' . $page));
    break;
    case "occasion_manage_delete":
        $hms_info_obj->occasionDelete($id);
        redirect (href_link(FILENAME_OCCASION_INFO, 'page=' . $page));
    break;
    case "delete_selected_hmsInfo_manage_records":
        $hms_info_obj->deleteOccasionMultipleRecord();
        redirect (href_link(FILENAME_OCCASION_INFO, 'page=' . $page));
    break;
}
?>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/occasion_info.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_BASIC_INFO . FILENAME_OCCASION_INFO);?>
         </td>
       </tr>
     </table>
   </td>
