...
checklogin();
$module_title = TITLE_MANAGE_FACILITY_ENTRY;
$hms_info_obj = new hmsInfo();

if (! is_allow_module($_COOKIE["admin_id"], 66) ) {
...
switch ($_REQUEST['action']) {
    case "facility_entry_insert":
        $hms_info_obj->facilityEntryInsert();
        redirect (href_link(FILENAME_FACILITY_ENTRY, 'page=' . $page));
    break;
    case "facility_entry_update":
        $hms_info_obj->facilityEntryUpdate();
        redirect (href_link(FILENAME_FACILITY_ENTRY, 'page=' . $page));
    break;
    case "facility_entry_delete":
        $hms_info_obj->facilityEntryDelete($id);
        redirect (href_link(FILENAME_FACILITY_ENTRY, 'page=' . $page));
    break;
    case "facility_selected_hmsInfo_manage_records":
        $hms_info_obj->deleteFacilityEntryMultipleRecord();
        redirect (href_link(FILENAME_FACILITY_ENTRY, 'page=' . $page));
    break;
}
?>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/Facility_Entry.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_BASIC_INFO . FILENAME_FACILITY_ENTRY);?>
         </td>
       </tr>
     </table>
   </td>
