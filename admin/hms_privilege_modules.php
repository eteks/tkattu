...
checklogin();
$module_title = "User Privilege Modules";
...
switch($_POST["action"]){
    ...
    redirect ( href_link ( FILENAME_HMS_PRIVILEGE_MODULES, 'parent_id='.$_POST["parent_id"] ) );
	break;
    ...
    case "privilege_module_delete":
        ...
        redirect (href_link(FILENAME_HMS_PRIVILEGE_MODULES, 'parent_id=' . $_GET["parent_id"]));
    break;
}
?>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_PRIVILEGE_USER . 'hms_privilege_modules.php');?> </td>
         </td>
       </tr>
     </table>
   </td>
