        ...
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
          ...
          <p>&nbsp;</p></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
			  ...
			  <tr>
                  <td colspan="2" class="tahoma11blacknormal" style="text-align:right;"><img src="images/arrow-l.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;<a href="<? print FILENAME_HMS_PRIVILEGE_ROLES."?parentid=".$privilegeRolseClass->getPreviousParentId($parentid);?>">Back to Roles list</a></td>
              </tr>
            </table>
            <?php
            }
            ...
            <tr>
               ...
               <td class="tahoma11blacknormal" bgcolor="<? echo $bgcolor ?>" style="text-align:center"><?php if ($privilegeRolseClass->getAdminRoleMasterParentValue($adminrole_mst_values["id"])==1) {?><a href="<?php echo href_link(FILENAME_HMS_PRIVILEGE_ROLES, 'parentid='.$adminrole_mst_values["id"]); ?>"><img src=<?print DIR_WS_IMAGES.'cam.gif';?> width="15" height="15" alt="View" border="0" title="Click to view details"></a><?php } else {?> <img src=<?print DIR_WS_IMAGES.'nocam.gif';?> width="15" height="15" alt="View" border="0"><?php }?></td>
               <td style="text-align:center"><a href="<? echo href_link(FILENAME_HMS_PRIVILEGE_ROLES, 'id=' . $adminrole_mst_values["id"] . '&action=privilege_roles_edit&parentid='.$adminrole_mst_values["parent_id"]) ?>"><img src="images/edit.gif" width="15" height="15" alt="Edit" border="0" title="Click to edit"></a></td>
           ...
           <?php
            ...
            print "<br/><CENTER><span style='color:#000000;'><b>NO ROLES FOUND</b></span><CENTER>";
        }
    }
