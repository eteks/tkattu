...
checklogin();
$module_title = TITLE_MANAGE_DEPARTMENT_CREATION;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"], 74) ) {
...
switch ($_REQUEST['action']) {
    case "department_insert":
        $hms_info_obj->departmentInsert();
        redirect (href_link(FILENAME_DEPARTMENT_CREATION, 'page=' . $page));
    break;
    case "department_update":
        $hms_info_obj->departmentUpdate();
        redirect (href_link(FILENAME_DEPARTMENT_CREATION, 'page=' . $page));
    break;
    case "department_manage_delete":
        $hms_info_obj->departmentDelete($id);
        redirect (href_link(FILENAME_DEPARTMENT_CREATION, 'page=' . $page));
    break;
    case "delete_selected_hmsInfo_manage_records":
        $hms_info_obj->deletedepartmentMultipleRecord();
        redirect (href_link(FILENAME_DEPARTMENT_CREATION, 'page=' . $page));
    break;
}
?>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/Department_Creation.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INFRASTUCTURE . FILENAME_DEPARTMENT_CREATION);?>
         </td>
       </tr>
     </table>
   </td>
