...
checklogin();
$module_title = TITLE_MANAGE_VENDOR_CREATION;
$hms_info_obj = new hmsInfo();
if (! is_allow_module($_COOKIE["admin_id"], 83) ) {
...
switch ($_REQUEST['action']) {
    case "vendor_insert":
        $hms_info_obj->vendorInsert();
        redirect (href_link(FILENAME_VENDOR_CREATION, 'page=' . $page));
    break;
    case "vendor_update":
        $hms_info_obj->vendorUpdate();
        redirect (href_link(FILENAME_VENDOR_CREATION, 'page=' . $page));
    break;
    case "vendor_manage_delete":
        $hms_info_obj->vendorDelete($id);
        redirect (href_link(FILENAME_VENDOR_CREATION, 'page=' . $page));
    break;
    case "delete_selected_hmsInfo_manage_records":
        $hms_info_obj->deletevendorMultipleRecord();
        redirect (href_link(FILENAME_VENDOR_CREATION, 'page=' . $page));
    break;
}
?>
...
<head>
	...
	<script language="javascript" type="text/javascript" src="js/vendor_creation.js"></script>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td height="350" bgcolor="<?=SECONDROWCOLOR?>" width="100%" align="center" valign="top">
             <?php require_once(DIR_WS_INVENTORY . FILENAME_VENDOR_CREATION);?>
         </td>
       </tr>
     </table>
   </td>
