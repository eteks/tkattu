...
$privilegeUser_obj = new privilegeUserClass;
$_GET["page"] = (isset($_GET["page"]) && !empty($_GET["page"]) ? $_GET["page"]:"");
...
if (count($privilege_user_master_role_arr) > 1 || $total_user_master_no) { ?>
  <form name="frmPrivilegeUserMenu" method="get" action="<? echo href_link(FILENAME_PRIVILEGE_USERS); ?>">
  ...
  <tr><td></td></tr>
        ...
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" height="30" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_PRIVILEGE_USER;?></td>
			</tr>
		  </table></td>
      </tr>
  <tr>
    ...
    if ($role_master_id) {
        if ($total_records) {
            ...
            ?><form name="frmPrivilegeUsers" method="POST" action="<?php echo href_link(FILENAME_PRIVILEGE_USERS,'parent_id=' . $role_master_id . '&page=' . $startpage); ?>"><input type="hidden" name="action"><input type="hidden" name="id">
            ...
            ?>
            <tr>
                <th style="text-align:center" style="padding-left:10px;">User Name</th>
            ...
            while ($users_master_values = db_fetch_array($user_master_result)) {
                if($user_master_counter < PAGINATION_DISPLAYED_RECORDS + 1) {
                    ...
                    ?><tr>
                        ...
                        <td bgcolor="<? echo $bgcolor ?>" width="3%" style="text-align:center"><a title="edit module" href="<?php echo href_link(FILENAME_PRIVILEGE_USERS, 'page='.$startpage.'&parent_id=' . $role_master_id . '&id=' . $users_master_values["id"] . '&action=privilege_user_edit'); ?>"><img src="images/edit.gif" width="15" height="15" alt="Edit" border="0"></a></td>
            ...
            print "<center><span class=\"normaltext\"><b>NO USERS FOUND IN THIS SELECTED ROLE</b></span></center>";
        }
    } else {
        print "<center><span class=\"normaltext\"><b>SELECT ROLE TO VIEW USER LIST</b></span></center>";
    }
} else {
    print "<center><span class=\"normaltext\"><b>NO ROLES FOUND! PLEASE ADD ROLE</b></span></center>";
}
