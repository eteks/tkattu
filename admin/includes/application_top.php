...
define('PROJECT_VERSION', 'Atomicka Softtech Pvt Ltd');
...
//require(DIR_WS_FUNCTIONS . 'blogs_functions.php');
require(DIR_WS_CLASSES . 'datetimeclass.php');

$file_basename = basename($PHP_SELF);
$file_name = explode("." ,$file_basename);
/*$file_basename = $file_name[0] . '.php';
if (file_exists(DIR_WS_FUNCTIONS . $file_basename)) {
   require(DIR_WS_FUNCTIONS . $file_basename);
}*/
//include class file
