...
class privilegeUserClass {
 ...
 function privilegeUserInsert () {
    $privilege_user_insert_sql = "INSERT INTO " . TABLE_ADMIN_MASTER . " ( `id`, `admin_role_mst_id`, `username`, `password`, `first_name` , `last_name`, `email`, `active` , `date_added` , `date_modified` ) VALUES ( '', '" . $_POST["parent_id"] ."' ,  '" . addslashes($_POST["uname"]) . "', '" . addslashes($_POST["pword"]) . "', '" . addslashes($_POST["fname"]) . "', '" . addslashes($_POST["lname"]) . "', '" . addslashes($_POST["email"]) . "', '" . $_POST["active"] . "', NOW(), NULL)";
