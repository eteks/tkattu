<?php
    $unit_obj        = new hmsInfo();
    $student_user_all_result = $unit_obj->unitSingRec();
        ...
        <tr>
            <td valign="top">
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <?php } ?>
                    <tr>
                        <td width="15%" class="tahoma12blackbold">Unit:&nbsp;</td>
                        <td class="tahoma11blacknormal"><?php echo stripslashes($student_user_values["unit_name"]);?></td>
                    </tr>
                    <tr>
