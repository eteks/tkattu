<?php
    $bedDetails_entry_obj        = new bedDetails();
    $student_user_all_result = $bedDetails_entry_obj->bedDetailsEntrySingRec();
        ...
        <tr>
            <td valign="top">
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    <tr>
					<tr>
                        <td width="15%" class="tahoma12blackbold">BedCharge:&nbsp;</td>
                        <td class="tahoma11blacknormal">Rs.<?php echo $student_user_values["hms_bed_details"]; echo ".00";?>                    </td>
                    </tr>
