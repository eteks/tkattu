...
*/
$privilegeModulesClass = new UserprivilegeModulesClass;
...
if ($_GET["action"] == "privilege_module_add" || $_GET["action"] == "privilege_module_edit") {
    ...
    if ($_GET["action"] == "privilege_module_add") {
        $privilege_module_master_values["sort_order"] = $privilegeModulesClass->getPrivilegeMaxSortOrder(TABLE_HMS_MODULE_MASTER, $module_sql_cond) + 1;
        ...
        if (not_null ($_GET["id"])) {
            ...
            redirect (href_link(FILENAME_HMS_PRIVILEGE_MODULES, 'parent_id='.$module_parent_id));
        }
    }
    ...
    ?><form name="frmPrivilegeModules" method="POST" enctype="multipart/form-data" action="<?php echo href_link(FILENAME_HMS_PRIVILEGE_MODULES); ?>">
	
	<input type="hidden" name="action" value="<?php echo ${$_GET["action"]}; ?>"><?php
        ...
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_HMS_PRIVILEGE_MODULES;?></td>
			</tr>
		  </table>
          <p>&nbsp;</p></td>
      </tr>>
 ...
 <tr><td></td></tr>
		...
		<div class="heading_light_blue" style="padding-bottom:4px;padding-left:6px;text-align:left;"><img src="images/arrow_heading.gif" />&nbsp;<?php echo TITLE_MANAGE_HMS_PRIVILEGE_MODULES;?></div> </form>  
    <div id="hms_privilege_modules_records"></div><table width="99%" border="0" cellspacing="0" cellpadding="2" align="center">
    <tr>
        <td height="5"></td>
    </tr>
    <tr>
        <td><img src="images/newfolder.gif" width="16" height="16" align="absbottom" alt="Add Module">&nbsp;&nbsp;<a title="add new module" class="tahoma11blacknormal" href="<?php echo href_link(FILENAME_HMS_PRIVILEGE_MODULES, 'parent_id=' . $module_parent_id . '&action=privilege_module_add'); ?>"><b>Add Module</b></a></td>
    </tr>
    </table>
    <script language="javascript" type="text/javascript">
    <!--//
