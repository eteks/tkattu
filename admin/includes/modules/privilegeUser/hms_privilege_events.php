...
if ($_GET["action"] == "privilege_module_event_add" || $_GET["action"] == "privilege_module_event_edit") {
    ...
    if ($_GET["action"] == "privilege_module_event_edit" ) {
        if (not_null ($_GET["id"])) {
            ...
            redirect (href_link(FILENAME_HMS_PRIVILEGE_EVENTS, 'event_module_parent_id='.$_GET["event_module_parent_id"]));
        }
    } 
...
<form name="frmPrivilegeEventModules" method="POST" enctype="multipart/form-data" action="<?php echo href_link(FILENAME_HMS_PRIVILEGE_EVENTS); ?>">
...
<form name="frmeventRecords" method="GET">
 ...
 <tr><td></td></tr>
		...
		<div class="heading_light_blue" style="padding-bottom:4px;padding-left:6px;text-align:left;"><img src="images/arrow_heading.gif" />&nbsp;<?php echo TITLE_MANAGE_HMS_PRIVILEGE_EVENTS;?></div>
    ...
    <div id="privilege_events_records"></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
          <tr>
            ...
            <tr>
                <td style="padding-bottom:4px;padding-left:6px;text-align:left;"><img src="images/newfolder.gif" width="16" height="16" align="absbottom" alt="Add Event">&nbsp;&nbsp;<a title="add new event" class="tahoma11blacknormal" href="<?php echo href_link(FILENAME_HMS_PRIVILEGE_EVENTS, 'action=privilege_module_event_add&event_module_parent_id='.$module_event_parent_id); ?>"><b>Add Events</b></a></td>
            </tr>
        </table>
