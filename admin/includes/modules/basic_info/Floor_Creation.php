...
if ($action == "occasion_edit" ) {
    $student_user_result = $hms_info_obj->floorEntrySingRec();
...
<form name="frmStudentUser" method="POST" enctype="multipart/form-data" action="<?php echo href_link(FILENAME_FLOOR_CREATION); ?>">
   ...
   <input type="hidden" name="page" value="<?php echo (isset($page) ? $page : 1); ?>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2">
        ...
        <tr>
            <td width="16%" class="tahoma12blacknormal padding_left">Floor Name:</td>
            <td width="87%" colspan = "2" class="tahoma12blacknormal padding_left">
             <input name="floor_name" type="text"  id="floor_name" tabindex="1" dir="ltr" size="40%" value="<?php print stripslashes( $floor_entry_values["hms_floor_entry_name"];) ?>" ONCHANGE="validatePresent(this, 'error_floor_name');">&nbsp;<span id="error_floor_name" class="tahoma10rednormal"><?php if (! not_null ($facility_entry_values["hms_floor_entry_name"]) ) { ?>Required<?php } ?></span>
          </td>
        </tr>
        <tr>
