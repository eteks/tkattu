<?php
    $occasion_entry_obj        = new hmsInfo();
    $student_user_all_result = $occasion_entry_obj->occasionEntrySingRec();
            ...
            <td valign="top">
                <table border="0" cellspacing="0" cellpadding="4" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="tahoma11blacknormal"><?php echo stripslashes($student_user_values["hms_occasion_entry_name"]);?></td>
                    </tr>
                    <tr>
