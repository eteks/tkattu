  ...
  <b>BACK TO MAIN LIST</b></a>
         ...
         <td height="203" valign="middle" class="verdanablack"><br />
           <table width="100%" border="1" cellpadding="0" cellspacing="0">
             ...
             <tr>
                <td height="37" colspan="9" align="center" bgcolor="#D7DBB0">Reservation Cancel</td>
             </tr>
             <tr >
                <td height="19">&nbsp;</td>
              ...
              <tr >
                ...
                <td colspan="2"><input type="text" name="ddDateFrom" id="ddDateFrom" value="<?php if (isset($_POST["ddDateFrom"]))                { echo $_POST["ddDateFrom"]; }?>" class="selectinput" /><img src="images/Calendar New.jpg" width="16" height="16"                  style="cursor:pointer" onClick="return showCalendar('ddDateFrom','%Y-%m-%d',24, true);" /></td>
  ...
  <tr>
    <td height="30" align="right" valign="middle" class="verdanablack"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr class="tableborder">
        <td width="9%" height="30" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack">Room No</td>
        <td width="9%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack">Type </td>
        <td width="13%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Customer</span></td>
		 <td width="15%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Booking Date</span></td>
		  <td width="19%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Arrival Date </span></td>
		  <td width="19%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Departure Date </span></td>
		  <td width="16%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Cancellation </span></td>
