...
<table width="93%" align="center" cellpadding="0" cellspacing="0" class="tableborder">
  ...
  <b>BACK TO MAIN LIST</b></a></td></tr>
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="Table_Border_bottom_right">
              <tr >
                <td height="37" colspan="9" align="center" bgcolor="#D7DBB0"><span class="verdanabold">Arrival/Departure Report</span></td>
              </tr>
              <tr >
                <td height="19">&nbsp;</td>
   ...
   <tr>
					  ...
					  <a href="room_occupancy_report_print.php?from_date=03/02/2009&to_date=03/02/2009" target="_blank" title="PRINT"><img src="images/bt_print.jpg" width="51" height="22" border="0"></a></td>
  </tr>
  <tr>
  ...
  <tr align="center">
    <td class="tahoma12blacknormal padding_left"> <div align="center"><b>Arrival List On 31-02-2009</b> </div></td>
  </tr>
  ...
  <tr>
    <td height="30" align="right" valign="middle" class="verdanablack"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr class="tableborder">
        <td width="13%" height="30" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack">Sr.NO</td>
        <td width="16%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Customer Name</span></td>
        <td width="25%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Room No</span></td>
		 <td width="23%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Arrival Date</span></td>
      ...
      <tr class="tableborder">
        <td height="30" valign="middle" bgcolor="#E4E4E4">&nbsp;</td>
  ...
  <tr align="center">
    <td class="tahoma12blacknormal padding_left"> <div align="center"><b>Departure List On 31-02-2009</b> </div></td>
  </tr>
