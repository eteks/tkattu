...
<table width="93%" align="center" cellpadding="0" cellspacing="0" class="tableborder">
  ...
  <b>BACK TO MAIN LIST</b></a></td></tr>
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="Table_Border_bottom_right">
              <tr >
                <td height="37" colspan="9" align="center" bgcolor="#D7DBB0"><span class="verdanabold">Room Occupancy Summary</span></td>
              </tr>
              <tr >
                <td height="19">&nbsp;</td>
   ...
   <tr>
					  ...
					  <a href="room_occupancy_report_print.php?from_date=03/02/2009&to_date=03/02/2009" target="_blank" title="PRINT">
						<img src="images/bt_print.jpg" width="51" height="22" border="0"></a>
						</td>
                      </tr>
  ...
  <tr>
    <td height="30" align="right" valign="middle" class="verdanablack"><table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
      ...
      <tr class="tableborder">
        <td width="13%" height="30" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack">Room No</td>
        <td width="16%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Type</span></td>
        <td width="25%" align="center" valign="middle" bgcolor="#CCCCCC" class="verdanablack"><span class="Under_Border_black">Customer</span></td>
  ...
  <tr>
    <td height="30" align="left" valign="middle" class="verdanablack">&nbsp;</td>
  </tr>
</table>
