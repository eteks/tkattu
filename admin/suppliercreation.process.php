...
switch ($action) {
    case "suppliercreation_update_active":
...
?>
<form name="frmnewsletter_manageRecords" method="get" action="<? echo href_link(FILENAME_SUPPLIER);?>" style="margin:0px;">
      ...
      <tr>
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" height="20" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_SUPPLIER_CREATION;?></td>
			</tr>
		  </table></td>
      </tr>
   <tr>
    ...
    <tr>
         ...
         <th width="19%" style="text-align:center" >Supplier Name</th>
    ...
    <tr>
		...
		<td width="6%" align="center" bgcolor="<? echo $bgcolor ?>" ><a href="javascript:populateHotelInfoManageLists ('<?php echo $hms_info_values["supplier_id"] ?>', 'suppliercreation_update_active', '<?php echo (($hms_info_values["active"] == "Y") ? "N" : "Y"); ?>', '<? print $page ;?>', '');"><img src="images/<?php echo $hms_info_values["active"]; ?>.gif" border="0" <?php if ($hms_info_values["active"]=='Y'){print "title='Click to disable'";} else { print "title='Click to enable'";}?>></a></td>

        <td width="4%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<?php echo FILENAME_SUPPLIER_VIEW . '?id=' . $hms_info_values["supplier_id"]; ?>" onClick="return hs.htmlExpand(this, { objectType: 'ajax'} )"><img src="images/view.gif" width="16" height="16" border="0" /></a></td>

        <td width="6%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<?php echo href_link(FILENAME_SUPPLIER, 'id=' . $hms_info_values["supplier_id"] . '&action=suppliercreation_edit&page=' . $page) ?>"><img src="images/edit.gif" alt="Edit" border="0" title="Click to edit"></a></td>

        <td width="6%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="javascript:deleteHmsInfoManageRecord(document.frmnewsletter_manageRecords, 'suppliercreation_manage_delete', '<?php echo $hms_info_values["supplier_id"] ?>')"><img src="images/delete.gif" alt="Delete" border="0" title="Click to delete"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
  <tr>
   <td colspan="10" height="30" class="gray_headline"><table border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td style="padding-left:6px"><img src="images/arrow_heading.gif" /></td>
       <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_SUPPLIER_CREATION;?></td>
     </tr>
   </table></td>
  </tr>
  <tr>
