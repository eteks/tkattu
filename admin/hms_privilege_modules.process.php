...
if ( db_num_rows ( $modules_master) >0 ) {
    ?>
    <form name="frmPrivilegeModules" method="POST" action="<?php echo href_link(FILENAME_HMS_PRIVILEGE_MODULES,'parent_id='.$module_parent_id); ?>"><input type="hidden" name="action"><input type="hidden" name="id">
<?php
    ...
    <tr class="<?php echo $bgcolor;?>">
       ...
       <?php
        ...
        <td style="text-align:center" class="tahoma11blacknormal" bgcolor="<? echo $bgcolor ?>"> <a title="edit module" href="<?php echo href_link(FILENAME_HMS_PRIVILEGE_MODULES, 'parent_id=' . $module_parent_id . '&id=' . $modules_master_values["id"] . '&action=privilege_module_edit'); ?>"><img src="images/edit.gif" width="15" height="15" alt="Edit" border="0"></a></td>
