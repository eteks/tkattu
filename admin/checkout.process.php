...
switch ($action) {
    case "checkout_entry_update_active":
        $hms_info_obj->checkoutUpdateActive();
    break;
}
...
?>
<form name="frmnewsletter_manageRecords" method="get" action="<? echo href_link(FILENAME_CHECKOUT);?>" style="margin:0px;">
...
<tr><td></td></tr>
      <tr>
        <td  colspan="11" ><table border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td align="left" class="heading_light_blue">&nbsp;<?php echo TITLE_MANAGE_CHECKOUT_TIME;?></td>
			</tr>
		  </table></td>
      </tr>
   <tr>
    ...
    <tr>
         ...
         <th width="30%" style="text-align:center" >CheckOut Time</th>
   ...
   <? if($hms_info_values["hms_checkout_time"]) echo $hms_info_values["hms_checkout_time"].":00 Hours"; else echo $hms_info_values["hms_checkout_time"].":00 Hours"; ?></td>
		...
		<td width="5%" align="center" bgcolor="<? echo $bgcolor ?>" ><a href="javascript:populateHotelInfoManageLists ('<? echo $hms_info_values["hms_checkout_id"] ?>', 'checkout_entry_update_active', '<? echo (($hms_info_values["active"] == "Y") ? "N" : "Y"); ?>', '<? print $page ;?>', '');"><img src="images/<? echo $hms_info_values["active"]; ?>.gif" border="0" <? if ($hms_info_values["active"]=='Y'){print "title='Click to disable'";} else { print "title='Click to enable'";}?>></a></td>

        <td width="5%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo FILENAME_CHECKOUT_VIEW . '?id=' . $hms_info_values["hms_checkout_id"]; ?>" onClick="return hs.htmlExpand(this, { objectType: 'ajax'} )"><img src="images/view.gif" width="16" height="16" border="0" /></a></td>

        <td width="5%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="<? echo href_link(FILENAME_CHECKOUT, 'id=' . $hms_info_values["hms_checkout_id"] . '&action=checkout_edit&page=' . $page) ?>"><img src="images/edit.gif" alt="Edit" border="0" title="Click to edit"></a></td>

        <td width="5%" style="text-align:center" bgcolor="<? echo $bgcolor ?>"><a href="javascript:deleteHmsInfoManageRecord(document.frmnewsletter_manageRecords, 'checkout_manage_delete', '<? echo $hms_info_values["hms_checkout_id"] ?>')"><img src="images/delete.gif" alt="Delete" border="0" title="Click to delete"></a></td>
