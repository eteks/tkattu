...
switch ($action) {
	...
	if(isset($_POST['ddDateFrom']) && $_POST['ddDateFrom'] != "" ) { 
	  $order_query = "SELECT * FROM " . TABLE_HMS_RESTAURANT_ACCOUNT_DETAILS . " WHERE tabel_id='0' AND  orde_close_date BETWEEN '$FromDate' AND '$ToDate' AND status = 'close'";	 
	}	 
...
<td width="421" align="center"><a href="javascript:void(0);" Onclick="Javascript:getparcelsales('parcelsales');" class="submenu" > Show</a></td>		
</tr>
<tr>
  <td align="center">&nbsp;</td>
  <td align="center">&nbsp;</td>
...
<tr >
<td height="38"  colspan="14" align="center" valign="middle" bgcolor="#D7DBB0" class="verdanabold">Parcel Sales Report Details</td>
</tr>
<tr>
<td align="right"></a></td>
</tr>
...
$Purchase_total_amount = "SELECT sum(total_amount) as total_amount FROM " . TABLE_HMS_RESTAURANT_ACCOUNT_DETAILS . " WHERE tabel_id='0' AND orde_close_date BETWEEN '$FromDate' AND '$ToDate' AND status = 'close'";  
...
?>		
 ...
 <input name="btnPrint" type="button" id="btnPrint" class="submit"
  value="Print" onClick="getparcelsalesview('<?php echo $FromDate; ?>','<?php echo $ToDate; ?>');">
  </td>
  </tr>						
