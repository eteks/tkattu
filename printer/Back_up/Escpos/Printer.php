...
namespace printer\Escpos;

use Exception;
use InvalidArgumentException;
use printer\Escpos\PrintBuffers\PrintBuffer;
use printer\Escpos\PrintBuffers\EscposPrintBuffer;
use printer\Escpos\PrintConnectors\PrintConnector;
use printer\Escpos\CapabilityProfiles\AbstractCapabilityProfile;
use printer\Escpos\CapabilityProfiles\DefaultCapabilityProfile;
