...
function selected(cal, date) {
 ...
 cal.callCloseHandler();
	var date1=document.getElementById('ddDateFrom').value;
	//alert(date1);
	var date2=document.getElementById('ddDateTo').value;
	//alert(date2);
if(date2!="")
	   {
	 m1=date1.substr(0,2);
...
/*  m2=date2.substr(5,2);
  ...
  y2=date2.substr(0,4);*/
   ...
   var frm_dt =new Date(y1, m1, d1);
    //Month is 0-11 in JavaScript
 var to_dt=new Date(y2, m2, d2);
  ...
  // alert(m2+" "+d2+" "+y2+" "+date1+"-"+date2+"--"+to_dt+"-"+diff+"-"+frm_dt);
  if (frm_dt == to_dt)
  {
