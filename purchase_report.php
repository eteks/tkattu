...
switch ($action) {
	...
	if(isset($_POST['sel_bill']) && $_POST['sel_bill'] != "" ) { 
	  $order_query = "SELECT * FROM " . TABLE_HMS_RESTAURANT_ACCOUNT_DETAILS . " WHERE bill_id ='" .trim($_POST["sel_bill"]). "' AND  status = 'close'";	 
	}	 
        ...
        <td><table width="95%" align="center" cellpadding="0" cellspacing="0" class="tableborder">
          ...
          <tr>
            <td width="100%" height="30" align="center" valign="middle" class="verdanablack"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <th height="30" bgcolor="#D7DBB0" class="style1" scope="col">Purchase Report</th>
                </tr>
              </table></td>
            </tr>
          <tr>
            ...
            <!--  <tr class="tableborder">
                <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                 ...
                 <td align="right" valign="middle" width="350" class="verdanablack">Tax:</td>
              ...
              <tr class="tableborder">
                <td width="1%" height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                  ...
                  <td width="39%" align="right" valign="middle" class="verdanablack"><label>Vendor Name : </label></td>
...
<option  value="All">All</option>
	...
	<option value="<?php echo $hms_info_values1['vendor_id']; ?>"> <?php echo $hms_info_values1['vendor_name']; ?> </option>
      ...
      ?>
                  ...
                  <td width="23%" align="center" valign="middle" class="verdanablack">&nbsp;</td>
                </tr>
              <tr class="tableborder">
                <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                  <td align="center" valign="middle" class="verdanablack">&nbsp;</td>
...
<input name="ddDateTo" id="ddDateTo" type="text" tabindex="20" class="inputCopy1" size='16' value=""/><img src="images/Calendar New.jpg" width="16" height="16" style="cursor:pointer" onclick="return showCalendar('ddDateTo','%Y-%m-%d',24, true);" /></td>
              ...
              <tr class="tableborder">
                <td height="40" align="right" valign="middle" class="verdanablack">&nbsp;</td>
                  ...
                  <a href="javascript:void(0);" Onclick="Javascript:return getPurchaseList();" class="submenu" > Show</a></td>
